...
module "vnet-fgt-regiona" {
    ...
    vnet-spoke-1-cidr   = cidrsubnet(var.vnet-spokes-cidr-regiona,1,0)
    vnet-spoke-2-cidr   = cidrsubnet(var.vnet-spokes-cidr-regiona,1,1)
}
...
module "vnet-fgt-regionb" {
    ...
    vnet-spoke-1-cidr   = cidrsubnet(var.vnet-spokes-cidr-regionb,1,0)
    vnet-spoke-2-cidr   = cidrsubnet(var.vnet-spokes-cidr-regionb,1,1)
}
...
module "fgt-ha-regiona" {
    ...
    hub-vxlan-ip-1         = "10.10.30.1"
    hub-vxlan-ip-2         = "10.10.30.17"
    hub2-vxlan-ip-1        = "10.10.30.2"
    hub2-vxlan-ip-2        = "10.10.30.18"
    ...
    subnets-spokes = {
      "n-spoke-vm-1_net"  = module.vnet-fgt-regiona.subnets-spokes["n-spoke-vm-1_net"]
      "n-spoke-vm-2_net"  = module.vnet-fgt-regiona.subnets-spokes["n-spoke-vm-2_net"]
      "n-spoke-rs-1_net"  = module.vnet-fgt-regiona.subnets-spokes["n-spoke-rs-1_net"]
      "n-spoke-vm-1_name" = module.vnet-fgt-regiona.subnets-spokes["n-spoke-vm-1_name"]
      "n-spoke-vm-2_name" = module.vnet-fgt-regiona.subnets-spokes["n-spoke-vm-2_name"]
      "n-spoke-rs-1_name" = module.vnet-fgt-regiona.subnets-spokes["n-spoke-rs-1_name"]
    }
}
...
module "fgt-ha-regionb" {
    ...
    hub-vxlan-ip-1         = "10.10.30.2"
    hub-vxlan-ip-2         = "10.10.30.18"
    hub2-vxlan-ip-1        = "10.10.30.1"
    hub2-vxlan-ip-2        = "10.10.30.17"
    ...
    subnets-spokes = {
      "n-spoke-vm-1_net"  = module.vnet-fgt-regionb.subnets-spokes["n-spoke-vm-1_net"]
      "n-spoke-vm-2_net"  = module.vnet-fgt-regionb.subnets-spokes["n-spoke-vm-2_net"]
      "n-spoke-rs-1_net"  = module.vnet-fgt-regionb.subnets-spokes["n-spoke-rs-1_net"]
      "n-spoke-vm-1_name" = module.vnet-fgt-regionb.subnets-spokes["n-spoke-vm-1_name"]
      "n-spoke-vm-2_name" = module.vnet-fgt-regionb.subnets-spokes["n-spoke-vm-2_name"]
      "n-spoke-rs-1_name" = module.vnet-fgt-regionb.subnets-spokes["n-spoke-rs-1_name"]
    }
}    
...
module "fgt-single-site1" {
    ...
    healthcheck-srv =  {
      healthcheck-za-srv-1  = azurerm_network_interface.za-ni-vm-spoke-1.private_ip_address
      healthcheck-za-srv-2  = azurerm_network_interface.za-ni-vm-spoke-2.private_ip_address
      healthcheck-zb-srv-1  = azurerm_network_interface.zb-ni-vm-spoke-1.private_ip_address
    }
    ...
    n-azure-hubs-cidr     = var.site-azure-cidr
    n-azure-hub1-cidr     = var.vnet-spokes-cidr-regiona
    n-azure-hub2-cidr     = var.vnet-spokes-cidr-regionb
}
