...
data "template_file" "site1FortiGate" {
  ...
  vars = {
    ...
    port3_gw        = cidrhost(azurerm_subnet.subnet-internal-site1.address_prefixes[0],1)
    ...
    spoke-site-cidr       = azurerm_subnet.subnet-spoke-site1.address_prefixes[0]
    ...
    mpls-to-az-1_ip       = "10.10.20.1"
    mpls-to-az-2_ip       = "10.10.20.2"
  }
}
